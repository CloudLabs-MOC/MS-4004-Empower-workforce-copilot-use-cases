...
In this hands-on lab, you will use Copilot in Teams to analyze meeting discussions related to the EcoSense 360 RFP Response Agent and identify opportunities for improvement. You will review recommendations from cross-functional stakeholders, prioritize the most impactful enhancements, and convert them into actionable instructions. These insights will help refine the agent and improve the quality of future RFP responses.

## Task 4: Use Copilot in Teams to collaborate on refining the RFP response agent

In this task, you will use Copilot in Teams to review a meeting transcript and extract recommendations for improving the EcoSense 360 RFP Response Agent. You will prioritize key enhancements and prepare them as instruction updates for the agent.

1. In Microsoft Edge browser, navigate to the **Microsoft 365** home page, select **App launcher** in the navigation pane, and then select **Teams** from the **App launcher** menu.
...
1. Once the files are uploaded, provide the following prompt **(1)** and then click on **Send (2)**:
   ...
   ![](../media/lab2-06-66.png)

6. Review the results. There were many recommendations, enter the below prompt.

   ![](../media/lab2-06-67.png)
...
7. Review the results. Plan is to update the Instructions for the agent, so need to reformat these insights from bulleted lists into paragraph form that you can insert into the agent’s instructions. Ask Copilot.
