...
In this task, you will use the Researcher agent to investigate external communication, workforce engagement, compliance, and operational trends that may influence AuroraHub’s communication strategy and employee experience.
...
1. In Microsoft 365, select **Researcher (1)** from the navigation pane.
...
In this task, you will compare the outputs of the Researcher agent and Copilot Chat to understand how each tool supports research, analysis, and strategic decision-making.
...
In this task, you will use the Researcher agent to generate a detailed research report and save the findings as a Word document for future reference and presentation development.
...
In this task, you will evaluate the relevance of identified trends for AuroraHub and assess compliance, regulatory, safety, and communication considerations that may impact implementation.
...
In this task, you will use the Researcher agent to create a concise executive summary that connects external research findings to AuroraHub’s communication strategy and business objectives.
...
In this task, you will generate a PDF version of the executive summary to create a shareable research artifact that can support executive reviews and future planning activities.
